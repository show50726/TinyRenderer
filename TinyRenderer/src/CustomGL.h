...
namespace Renderer {
	...
	public:
		...
		static void projection(float coeff);
	...
	public:
		...
		static void triangle(Vec4f* v, TGAImage &image, float* zbuffer, IShader* shader);
		static void model(Model* model, TGAImage &image, IShader* shader, float* zbuffer);
